<?php
// Settings file for HESK 2.6.5

// ==> GENERAL

// --> General settings
$hesk_settings['site_title']='Portal Aduan Kongres Rakyat';
$hesk_settings['site_url']='http://localhost/aduan';
...
$hesk_settings['language']='Bahasa Malaysia';
$hesk_settings['languages']=array(
'Bahasa Malaysia' => array('folder'=>'en','hr'=>'------ Reply above this line ------'),
);

// --> Database settings
$hesk_settings['db_host']='localhost';
$hesk_settings['db_name']='aduan';
$hesk_settings['db_user']='root';
$hesk_settings['db_pass']='';
$hesk_settings['db_pfix']='ad_';
...
// --> Help desk settings
$hesk_settings['hesk_title']='Portal Aduan';
$hesk_settings['hesk_url']='http://localhost/aduan';
...
$hesk_settings['secimg_sum']='UZB6PNZH57';
...
#     DO NOT EDIT BELOW     #
#############################
$hesk_settings['hesk_version']='2.6.5';
